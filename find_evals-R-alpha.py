...
#   Last modified: Tue 11 Mar 2014 11:17:48 GMT
#
# ----------------------------------------------------------------------------
"""
...
baseFilename = '-N{N}-M{M}-Re{Re}-b{b}-Wi{Wi}-amp{amp}-a{alpha}.dat'.format(
               N=N, M=M, Re=Re, b=beta, Wi=Weiss, amp=Amp, alpha=alpha)
